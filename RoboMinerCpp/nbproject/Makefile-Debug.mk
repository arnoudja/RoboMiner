...
${OBJECTDIR}/AnimationArrayData.o: AnimationArrayData.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I/usr/include/mysql -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AnimationArrayData.o AnimationArrayData.cpp
...
${OBJECTDIR}/ConfigFile.o: ConfigFile.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I/usr/include/mysql -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ConfigFile.o ConfigFile.cpp
...
${OBJECTDIR}/robotcode/DumpAction.o: robotcode/DumpAction.cpp 
	${MKDIR} -p ${OBJECTDIR}/robotcode
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I/usr/include/mysql -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/robotcode/DumpAction.o robotcode/DumpAction.cpp

${OBJECTDIR}/robotcode/DumpProgramItem.o: robotcode/DumpProgramItem.cpp 
	${MKDIR} -p ${OBJECTDIR}/robotcode
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I/usr/include/mysql -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/robotcode/DumpProgramItem.o robotcode/DumpProgramItem.cpp
...
${OBJECTDIR}/robotcode/OreValueProgramItem.o: robotcode/OreValueProgramItem.cpp 
	${MKDIR} -p ${OBJECTDIR}/robotcode
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I/usr/include/mysql -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/robotcode/OreValueProgramItem.o robotcode/OreValueProgramItem.cpp
...
${OBJECTDIR}/robotcode/TimeProgramItem.o: robotcode/TimeProgramItem.cpp 
	${MKDIR} -p ${OBJECTDIR}/robotcode
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I/usr/include/mysql -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/robotcode/TimeProgramItem.o robotcode/TimeProgramItem.cpp
