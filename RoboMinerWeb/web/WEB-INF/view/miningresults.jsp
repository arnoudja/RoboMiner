            ...
            <c:forEach var='miningResult' items='${miningResultsList}'>
                <tbody class="miningresults">
                    ...
                    <tr class="miningresultsdetails" name="resultDetails_${miningResult.id}">
                        <td></td>
                        <td>Queued:</td>
                        <td colspan="6"><fmt:formatDate value="${miningResult.creationTime}" timeZone="UTC" pattern="yyyy-MM-dd HH:mm:ss z" /></td>
                    </tr>
                    <tr class="miningresultsdetails" name="resultDetails_${miningResult.id}">
                        <td></td>
                        <td>Mining end:</td>
                        <td colspan="6"><fmt:formatDate value="${miningResult.miningEndTime}" timeZone="UTC" pattern="yyyy-MM-dd HH:mm:ss z" /></td>
                    </tr>
                </tbody>
            </c:forEach>
        </table>
